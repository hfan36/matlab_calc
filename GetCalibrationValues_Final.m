...
uc0 = 1096; %detector shift in pixels (width)
vc0 = 996; %detector shift in pixels (height)
delta_uc = 5; %tolerance in width
delta_vc = 5; %tolderance in height
N_grid = 10; %number of grid points
Rate = 1.2; %contraction rate
...
%     if loop_index == 1;
%         imwrite(A, map, 'test.gif', 'gif', 'LoopCount', 1, 'DelayTime', 2);
%     else
